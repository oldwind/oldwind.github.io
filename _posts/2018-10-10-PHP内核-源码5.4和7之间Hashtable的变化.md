...
花了很长时间了解php5.4的HashTable设计，实际上，我们能够感受出，php5.4的HashTable设计的非常简单，很容易理解，但是对于底层程序来说，性能的要求非常高，php7.0在性能上做了很多工作，bucket内存申请中，由原来的堆区申请变成栈区申请，php的洗能得到很大提高，分析php的hashtable，能刨出很多精彩的设计思想，后面的有时间还要继续深入的学习。